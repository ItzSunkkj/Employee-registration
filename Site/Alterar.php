...
<body>
    ...
    $sql = "UPDATE tb_funcionarios SET FUNCAO = '$Funcao' WHERE NOME = '$Nome'"; 
    ...
    <Label>A alteração de função do(a) funcionário(a) <?php echo"".$Nome." foi realizada com sucesso";?></Label>
